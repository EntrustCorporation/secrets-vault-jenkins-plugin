...
`Note :- The user will need to delete the file secret explicitly after using it, from the location.`
...
### Example :-
   ...
   ![Example](./img/exampleF1.png)
   
   ![Example](./img/exampleF2.png)
   
   ![Example](./img/exampleF3.png)
